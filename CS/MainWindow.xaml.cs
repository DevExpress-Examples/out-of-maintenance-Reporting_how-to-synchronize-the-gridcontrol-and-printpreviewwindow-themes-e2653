...
namespace WpfPrintGridThemeSync
{
    public partial class MainWindow : DXWindow
    {
        ...
        {
            VisualDataNodeLink link = new VisualDataNodeLink((DevExpress.Xpf.Grid.TableView)gridControl1.View, "My Document");
            DocumentPreviewWindow preview = new DocumentPreviewWindow();
            LinkPreviewModel linkPreviewModel = new LinkPreviewModel(link);

            preview.Model = linkPreviewModel;
